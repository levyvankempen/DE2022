...
if __name__ == '__main__':
    producer = KafkaProducer(bootstrap_servers='35.188.85.227:9092')  # use your VM's external IP Here!
    with open('C:\jads\DE2022\lab8\exercises\gamescore\game_data_split1.csv') as f:
        lines = f.readlines()
